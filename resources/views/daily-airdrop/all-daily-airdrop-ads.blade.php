...
<x-header/>
<div class="p-4">
    <h1 class="fs-4 text-center">Daily Airdrop Ads</h1>
    <details class=" my-4 mb-5  border rounded-3 shadow">
      <summary class="p-4 fs-4 fw-bold">Create Daily AirDrop Ads </summary>
      <div class="bg-light p-3">
        @include('dashboard.forms.daily-airdrop-ads-form')
      </div>
    </details>
